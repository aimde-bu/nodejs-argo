...
| NGROK_AUTHTOKEN | 否 | - | Ngrok authtoken (配置后使用 ngrok 替代 cloudflared) |
| NGROK_DOMAIN | 否 | - | Ngrok 固定域名 (需付费计划), 留空使用随机域名 |
| NGROK_REGION | 否 | auto | Ngrok 区域: us, eu, ap, au, sa, jp, in, auto |
